...
if "%PY%"=="" (
  ...
  echo   2. Ejecuta el instalador, marca "Add python.exe to PATH", pulsa "Install Now"
  echo      (si pregunta por privilegios de administrador, desmarca "Use admin privileges when installing py.exe")
...
"%VPY%" -m pip install -e "%ROOT%\engine[dev]" || (
  echo.
